...
if True:
    if True:
        if True:
            df_car_spawn = loadDemandFromFile("demand/Spawn_Cars_trip_reconstruction_perfect.csv")
            # df_car_spawn = loadDemandFromFile("demand/Spawn_Cars_trip_reconstruction_t4_enter.csv")
            # LAUNCH SUMO
            launchSUMO()
            # RUN SIMULATION
            ...
            traci.close()
            # copy all files
            os.rename("logs", "logs_trip_reconstruction_perfect")
            # os.rename("logs", "logs_trip_reconstruction_t4_enter")
